...
class QattenNet(nn.Module):
    ...
    def forward(self, agent_qs, states, actions):
        ...
        # 分别把各个智能体分开输入多头 head*num—agent*（batch_size, embed_di）
        ...
        for curr_head_keys, curr_head_selector in zip(all_head_keys, all_head_selectors):
            ...
            # (batch_size, 1, embed_dim) * (batch_size, embed_dim, agent_num)，q
            ...
            head_q = (agent_qs * th.abs(attend_weights)).sum(dim=2)
