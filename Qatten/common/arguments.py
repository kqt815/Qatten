...
def get_common_args():
    ...
    parser.add_argument('--map', type=str, default='MMM', help='the map of the game')    # matrixgame import Matrix_game2Env
    ...
    parser.add_argument('--method', type=str, default='qatten', help='whether to use the GPU')
...
def get_qatten_args(args):
    ...
    args.weight_hidden_dim2 = args.n_head
